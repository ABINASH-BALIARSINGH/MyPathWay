      ...
      >
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center space-x-2 mb-6">
            ...
            <span className="text-2xl font-bold text-gray-900">MyPathWay</span>
          </Link>
        ...
        <div className="space-y-3">
          <button 
            className="w-full border border-gray-300 text-gray-700 py-3 rounded-lg font-medium hover:bg-gray-50 transition-colors flex items-center justify-center disabled:opacity-50"
            disabled={isLoading}
          >
